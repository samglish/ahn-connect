...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 04 août 2025 à 13:43
...
INSERT INTO `etudiants` (`id`, `nom`, `prenom`, `matricule`, `numero`, `filiere`, `email`, `mot_de_passe`, `profile_pic`, `bio`) VALUES
(3, 'Abdoulatif', 'Abdoulaye', '24ENSPM178', '691681060', 'IAN', 'abdoulatifwirngoori@gmail.com', '$2y$10$K8AgDSI4DR2TD83.du9crOlEW28UG7bwAUHHEOvfdmJLOkucPByJS', 'default.jpg', NULL);
...
('root', '[{\"db\":\"gestion_etudiants\",\"table\":\"department_news\"},{\"db\":\"gestion_etudiants\",\"table\":\"etudiants\"}]');
...
('root', '2025-08-04 11:39:52', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"fr\",\"NavigationWidth\":0}');
